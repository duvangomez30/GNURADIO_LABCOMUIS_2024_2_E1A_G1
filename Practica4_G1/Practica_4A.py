...
class Practica_4A(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Practica_4A")
        ...
        self._GRX_win = qtgui.RangeWidget(self._GRX_range, self.set_GRX, "Ganancia_transmisor", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._GRX_win)
        self._Fcb_range = qtgui.Range(10e3, 100e3, 1e2, 100e3, 200)
        self._Fcb_win = qtgui.RangeWidget(self._Fcb_range, self.set_Fcb, "Frecuencia_corte_filtro", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.uhd_usrp_source_0.set_block_alias("uhd_usrp_source_0")
        ...
        self.connect((self.uhd_usrp_source_0, 0), (self.qtgui_freq_sink_x_2, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_2.set_frequency_range(self.Fc, self.samp_rate)
...
def main(top_block_cls=Practica_4A, options=None):

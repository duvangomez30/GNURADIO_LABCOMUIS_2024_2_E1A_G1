...
class Prueba00(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/labcomu/Documentos/Practica_2/rebelion_joearroyo.wav', True)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_1.set_taps(firdes.low_pass(1, self.samp_rate, self.fcut, self.t_band, window.WIN_HAMMING, 6.76))

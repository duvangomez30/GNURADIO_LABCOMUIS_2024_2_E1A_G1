...
# Author: Duvan_Gomez_Jose_Delgado_E1A_G1
...
class Lab_comu_I(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._frecuency_range = Range(1000, 40000, 1000, 2000, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, frecuency, 1, 0, 0)
